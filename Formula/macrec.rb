...
class Macrec < Formula
  ...
  url "https://github.com/ikhoon/macrec/releases/download/v0.5.0/macrec-0.5.0-macos-arm64.zip"
  version "0.5.0"   # explicit — else Homebrew mis-parses "64" from "arm64" in the filename
